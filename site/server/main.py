"""
Live state for the mousebrain site.
...
RPC = os.environ.get("MOUSE_RH_RPC", "https://rpc.mainnet.chain.robinhood.com")
CHAIN_ID = 4663
...
@app.get("/")
def root():
    return {"service": "mousebrain", "see": "/api/state"}
